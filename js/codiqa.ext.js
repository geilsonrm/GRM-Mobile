...
CodiqaControls.GoogleMap.prototype.initType = function() {
  if( window.CodiqaControls.getInstances('googlemaps').length ) {
    if(this._isInited) {
      ...
      script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyBG_7zdkoelzD_5pV8iwFpZdF0ic6qNPSA&sensor=true&callback=CodiqaControls.types.googlemaps.prototype.callbackInit";
